...
create_tables_cmd = [
    ...
    "CREATE TABLE  Categories(id INT UNSIGNED AUTO_INCREMENT, categories VARCHAR(500), code VARCHAR(50), PRIMARY KEY "
    "(id))ENGINE=INNODB;",
...
products_params = {
    ...
    "json": 1,
    "page": 1,
    "fields": "categories,stores,generic_name_fr,product_name_fr_imported,"
              "ingredients_text_with_allergens_fr,code,url,nutrition_grade_fr"
}
